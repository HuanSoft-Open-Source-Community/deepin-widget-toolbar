...
- **避諸面板**：他面板之實與右欄相疊者既出——通知之浮、通知之中心、控制中心、電源注销之框、剪貼板之面，及托盤快捷之卡與舒展之小卡——欄亦暫隱以避，俾其闔而移開即歸；與避多任務之觀同其術，并斂其浮窗。小卡之舒展不與欄相犯者，不復誤隱；其形勢不可知者，猶從舊避。唯 X11 行之，辨諸窗口 WM_NAME、WM_CLASS 之名，又校其坐位方圓之形（右欄之位，由全局之度與本屏縮率推之）
