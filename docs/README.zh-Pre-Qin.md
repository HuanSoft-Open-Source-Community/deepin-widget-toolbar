...
- **避諸面板**：他面板之實與右欄相疊者既出——通知之浮、通知之中心、控制中心、電源注销之框、剪貼板之面，及托盤快捷之卡與舒展之小卡（欄自有之十三乘十三停駐之窗不與焉）——欄亦暫隱以避，俾其闔而移開即歸；與避多任務之觀同其術，并斂其浮窗。小卡之舒展不與欄相犯者，不復誤隱。唯 X11 行之：辨諸窗口 WM_NAME、WM_CLASS 之名，又校其坐位方圓之形；至若右欄之位，則**直讀其自有之 X 窗（以像素計）**，故欄雖隱而其斷猶精。避之時，每二息必以窗樹之實復校之，托盤之鈕於顯之前亦先校——**凡令之未達者，終不復使欄永隱**；避之啟閉與滯案之清，皆以 info 之誌（`ds.widgettoolbar.panelavoid`）記之，以備後查
